...
func initApp(confServer *conf.Server, registry *conf.Registry, confData *conf.Data, tracerProvider *trace.TracerProvider) (*kratos.App, func(), error) {
	...
	sginSgin := sgin.NewSgin(defaultFileDir, engine, formatConversionUseCase, comparisonUseCase, transformUseCase, imageWordUseCase, qrcodeUseCase, userUseCase, centralUseCase, imageZoomUseCase)
